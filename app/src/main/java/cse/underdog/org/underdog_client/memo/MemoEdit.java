...
public class MemoEdit extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRowId = (savedInstanceState == null) ? null :
                (Long) savedInstanceState.getSerializable(MemoDbAdapter.KEY_ROWID);
        if (mRowId == null) {
            Bundle extras = getIntent().getExtras();
            mRowId = extras != null ? extras.getLong(MemoDbAdapter.KEY_ROWID)
                    : null;
        }
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        saveState();
        outState.putSerializable(MemoDbAdapter.KEY_ROWID, mRowId);
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.menu_about:
                ...
                AlertDialog.Builder dialog = new AlertDialog.Builder(MemoEdit.this);
    ...
    private void populateFields() {
        if (mRowId != null) {
            ...
            mTitleText.setText(note.getString(
                    note.getColumnIndexOrThrow(MemoDbAdapter.KEY_TITLE)));
            mBodyText.setText(note.getString(
                    note.getColumnIndexOrThrow(MemoDbAdapter.KEY_BODY)));
