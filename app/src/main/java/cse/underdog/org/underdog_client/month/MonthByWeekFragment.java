...
package cse.underdog.org.underdog_client.month;
...
import cse.underdog.org.underdog_client.Event;
import cse.underdog.org.underdog_client.Utils;
import cse.underdog.org.underdog_client.event.CreateEventDialogFragment;
...
public class MonthByWeekFragment extends SimpleDayPickerFragment implements
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        if (!mIsMiniMonth) {
            mListView.setBackgroundColor(theme.equals("dark") ?
                    (getResources().getColor(R.color.month_bgcolor_dark)) : (getResources().getColor(R.color.month_bgcolor)));
        }
